...
public class FeedbackController {
    ...
    public ResponseEntity<Map<String, Object>> getFeedback(@RequestBody FeedbackDTO request) {
        try {
            ...
            // 프롬프트 생성
            String systemPrompt = "당신은 챌린지 수행 데이터를 분석하여 피드백을 제공하는 AI 비서입니다. 평균과 사용자의 수행한 횟수는 꼭 비교하며 사용자의 챌린지 횟수를 기준으로 격려와 조언을 제공합니다. 조언은 두 문장으로 끝내주세요";
            String userPrompt = String.format(
                    "전체 회원들의 챌린지 시행 평균은 %d회 정도 수행합니다. 현재 사용자는 몇 %d회를 수행했습니다. " + "사용자가 동기부여를 가질 수 있도록 적절한 피드백을 제공하세요.",
